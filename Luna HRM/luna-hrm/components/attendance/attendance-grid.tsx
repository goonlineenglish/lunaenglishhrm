...
import { saveAttendanceBatch, lockWeek } from '@/lib/actions/attendance-actions'
...
export function AttendanceGrid({ initialRows, branchId, weekStart, isLocked, onSaved }: Props) {
    ...
    <div className="space-y-3">
      ...
      {isLocked && (
        <p className="text-sm text-destructive flex items-center gap-1">
          <Lock className="h-4 w-4" /> Tuần này đã khoá, không thể chỉnh sửa.
        </p>
      )}
